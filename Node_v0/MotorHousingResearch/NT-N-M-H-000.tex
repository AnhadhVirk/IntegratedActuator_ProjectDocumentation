...
\nervsetup{
  ...
  abstract={This document collates and analyses multiple research papers and notes for fulfilling Node v0 design goals in relation to motor housing design. Its intended purpose is to isolate observations, assumptions, risks, and design direction before committing to a detailed technical design.}
}
...
Several motion control companies provide mounting and installation guidelines for frameless BLDC motors, which can be applied to the Node v0 motor housing design.
\\\\
\textbf{Note:}
\\
...
Geometrically, axial clamping is easier to integrate into housing for inrunner motors vs outrunner motors, making it less suitable for the Node v0 actuator.
...
Rotor bonding is likely the most suitable method for the Node v0 actuator, since it is a low torque application and the rotor cup can be designed to have a smooth continuous interface with the rotor.
