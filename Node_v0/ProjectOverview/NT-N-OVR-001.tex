...
\nervsetup{
  ...
  summary={This overview will define the scope, goals and key deliverables, including timelines, of the Node v0 project. This is essential in ensuring project success is met in a desirable timeframe.}
}
...
industry.
NervTech systems aims to be at the forefront of this movement, and the Node v0 project
...
The eventual goal will be to develop a family of robotic components, including arms,
legs and end effectors, that can be easily configured to form a variety of robotic
...
\deliverablerow
  ...
  {Mechanical, electrical, firmware and verification design documents, plus simulated environment using CAD, for the Node v0 actuator.}
  {26/07/2026}
